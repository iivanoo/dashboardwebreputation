...
@Path("/Sorgenti/search/bobbles/nomefonte={fonte}/idutente={id}/topic={topic}")
public class BobblesForTopic {

	@GET
	@Produces(MediaType.TEXT_PLAIN)
	public String getBobblesLabels(@PathParam("fonte") String fonte, @PathParam("topic") String topic, @PathParam("id") int id ) {
		String result = "";
		try {
			List<String> sorgenti = this.getSorgenti(fonte, topic, id);
