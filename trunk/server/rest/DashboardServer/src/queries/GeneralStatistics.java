...
@Path("/Sorgenti/grafico/general/utente={Idutente}/data1={Data1}/data2={Data2}/data3={Data3}/data4={Data4}/data5={Data5}/data6={Data6}/data7={Data7}")  //Data1 < Data2 & formato: AAAA-MM-GG
public class GeneralStatistics{

	@GET
	@Produces(MediaType.TEXT_PLAIN)
	public String getGeneralStatistics(@PathParam("Idutente") int id, @PathParam("Data1") String d1, @PathParam("Data2") String d2, @PathParam("Data3") String d3, @PathParam("Data4") String d4, @PathParam("Data5") String d5, @PathParam("Data6") String d6, @PathParam("Data7") String d7) {
		//String result = "[";
		String result = "";
		try {
			
			result = this.getSorgenti(id,d1,d2, d3,d4,d5,d6,d7);
	...
	private String getSorgenti(int id, String d1, String d2, String d3, String d4, String d5, String d6, String d7) throws Exception {
		String nome="";
		String resu="";
		String risultato="[ ";
		int count;
		...
		Connection conn_nomi = DbManager.getConnection();
		Statement stmt_nomi = conn_nomi.createStatement();
		ResultSet rset_nomi = stmt_nomi.executeQuery("SELECT DISTINCT Nome FROM Sorgenti");
		while(rset_nomi.next()){
			nome = rset_nomi.getObject("Nome").toString();
			//prima settimana----------------------------------------------------------------------
			String d11 = "";
