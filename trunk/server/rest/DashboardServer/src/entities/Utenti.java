...
public class Utenti{
	...
	public Utenti(int id, String nome, String cognome, String email, String password, Date data, 
			String citta, int creatore, Date datains, boolean ad){
		this.ID = id;
		this.Nome = nome;
	...
	public Utenti(ResultSet resultSet){
		...
		this.Data_nascita = resultSet.getDate("Data_nascita");
		this.Citta = resultSet.getString("Citta");
		this.Creato_da = resultSet.getInt("Creato_da");
		this.Data_ins = resultSet.getDate("Data_ins");
	...
	public Utenti(String json){
		//TODO controllare il try/catch	
			...
			try{
				...
				this.Data_nascita = new Date(obj.getString("Data_nascita"));
				this.Citta = obj.getString("Citta");
				this.Creato_da = obj.getInt("Creato_da");
				this.Data_ins = new Date(obj.getString("Data_ins"));
	...
	/*public String toXML(){
		return "<Utenti>\n" +
				...
				"<Data_nascita>"+this.Data_nascita+"</Data_nascita>\n"+
				"<Citta>"+this.Citta+"</Citta>\n"+
				"<Creato_da>"+this.Creato_da+"</Creato_da>\n"+
				"<Data_ins>"+this.Data_ins+"</Data_ins>\n"+
	...
	*/
	...
	public void setData_nascita(Date data){ this.Data_nascita = data;}
	...
	public Date getData_ins(){return this.Data_ins;}
	public void setData_ins(Date inserimento){this.Data_ins = inserimento;}
